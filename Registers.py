...
entry_check1 = Checkbutton(win, text="javascript", variable=checkbox1).place(x=240, y=460)
...
Button(win, text='Submit', width=10, bg='gray', fg='white', command=validations).place(x=180, y=500)
Button(win, text='Clear ', width=10, bg='gray', fg='white', command=clear).place(x=50, y=500)
Button(win, text='Check', width=10, bg='gray', fg='white', command=view).place(x=320, y=500)
